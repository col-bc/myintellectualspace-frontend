        ...
        getJWT()
          .then((res) => {
            ...
            axios
              ...
              .catch((ex) => {
                // log headers
                console.log(ex.request.headers);
                console.log(ex);
                alert.value = {
                  show: true,
                  message:
                    "Error creating meeting. The server may be too busy.",
                };
                scrollToAlert();
    ...
    const handleJoinMeeting = () => {
      ...
      getJWT()
        .then((res) => {
          ...
          axios
            .get(
              `https://api.videosdk.live/v2/rooms/validate/${meetingId.value}`,
              {
                headers: {
...
<template>
  <div class="min-h-screen p-x2 flex flex-col">
    <NavbarComponent />
    <!-- Alert -->
    <div
      v-show="alert.show"
    ...
    <div
      class="container grid grid-cols-1 lg:grid-cols-4 space-4 mx-auto pb-12"
    >
      <div class="col-auto lg:col-span-3">
        <!-- View 0: Join/Host -->
        <div
          v-show="view === 0"
          class="container mt-8 flex flex-col max-w-xl mx-auto"
        >
          ...
          <img
            ...
            alt="Meeting"
            class="block w-full max-h-52 mx-auto my-12"
          />
          <button
            @click="view = 1"
          ...
          <span class="text-xl font-bold text-center my-4 text-gray-700"
            >OR</span
          >
            ...
            <div class="w-full">
              ...
              <div class="flex flex-row">
                <input
                  type="text"
                  v-model="meetingId"
                  class="w-full flex-1 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg rounded-r-none border-r-0 focus:ring-blue-500 focus:border-blue-500 p-2.5"
                />
                <button
                  type="button"
                  @click="handleJoinMeeting()"
                  class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 rounded-l-none"
                >
                  Join a meeting
                </button>
              </div>
          ...
          <div class="grid grid-cols-1 gap-4">
            ...
            >
              ...
              >
                ...
                <span>Your meeting features</span>
              </h5>
              <!-- Chat -->
              <div>
                <label
      ...
      <!-- Meeting Calendar  -->
      <div
        class="col-auto mt-8 mx-auto flex flex-col bg-white p-4 rounded-lg border border-gray-200"
      >
